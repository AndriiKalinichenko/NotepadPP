...
//Timer 
#define IDD_PREFERENCE_TIMER_SETTINGS_BOX 6270
	#define IDC_TIMERSETTINGS_GB_STATIC (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 1)
	#define IDC_STATIC_CHOOSE_TIMER_INTERVAL (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 2)
	#define IDC_EDIT_CHOOSE_TIMER_INTERVAL (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 3)
	#define IDC_SPIN_CHOOSE_TIMER_INTERVAL (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 4)
