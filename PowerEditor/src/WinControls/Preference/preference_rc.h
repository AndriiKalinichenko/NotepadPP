...
#define IDD_PREFERENCE_TIMER_SETTINGS_BOX 6270
	#define IDC_TIMER_SETTINGS_GB_STATIC (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 1)
	#define IDC_STATIC_TIMER_SETTINGS (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 2)
	#define IDC_EDIT_TIMER_SETTINGS (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 3)
	#define IDC_APPLY_TIMER_BTN (IDD_PREFERENCE_TIMER_SETTINGS_BOX + 4)
